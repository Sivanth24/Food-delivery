    ...
    >
        { data && data.map((item,index) => (
            <motion.div 
                ...
                key={item?.id} 
                className="w-300 min-w-[300px] md:w-340 md:min-w-[340px] h-[200px] mx-4 my-12 flex items-center justify-between bg-cardOverlay rounded-lg p-2 backdrop-blur-lg hover:drop-shadow-lg transition-all ease-in-out duration-100"
            >
                ...
                <div className="w-full flex flex-col items-end justify-end">
                    <motion.div whileTap={{scale: 0.75}} className="w-8 h-8 mb-12 rounded-full bg-red-600 flex items-center justify-center cursor-pointer hover:shadow-md">
